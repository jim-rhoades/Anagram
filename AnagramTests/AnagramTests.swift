...
class AnagramTests: XCTestCase {
	...
	let test5 = (string1: "Mia", string2: "I am") // true
	let test6 = (string1: "cinemma", string2: "ice man") // false
	...
	func testVersion1() {
		...
		XCTAssert(!isAnagramV1(string1: test6.string1, string2: test6.string2))
	}
	...
	func testVersion2() {
		...
		XCTAssert(!isAnagramV2(string1: test6.string1, string2: test6.string2))
	}
	...
	func testVersion3() {
		...
		XCTAssert(!isAnagramV3(string1: test6.string1, string2: test6.string2))
	}
	...
	func testVersion4() {
		...
		XCTAssert(!isAnagramV4(string1: test6.string1, string2: test6.string2))
	}
	...
	func testVersion5() {
		...
		XCTAssert(!isAnagramV5(string1: test6.string1, string2: test6.string2))
	}
	
	
	// TODO: figure out how to test performance here using release build instead of debug
	/*
